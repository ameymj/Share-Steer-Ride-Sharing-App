                                    ...
                                    <div className="card-body p-4 p-lg-5 text-black" style={{'backgroundColor':'rgb(5, 101, 134)'}}>
                                        ...
                                        <form>
                                            ...
                                            <div className="form-outline mb-4">
                                                <input type="text"  className="form-control form-control-lg" defaultValue={user.first_name} required minLength={5} maxLength={16} onBlur={(e) => { setFirstName(e.target.value) }} />
                                                <label className="form-label">First Name</label>
                                            </div>

                                            <div className="form-outline mb-4">
                                                <input type="text" className="form-control form-control-lg" defaultValue={user.last_name}  required minLength={3} maxLength={16} onBlur={(e) => { setLastName(e.target.value) }} />
                                                <label className="form-label">Last Name</label>
                                            </div>

                                            <div className="form-outline mb-4">
                                                <input type="date"  className="form-control form-control-lg" defaultValue={user.birth_date}  required minLength={5} maxLength={16} onBlur={(e) => { setBirthdate(e.target.value) }} />
                                                <label className="form-label">Birthdate</label>
                                            </div>

                                            <div className="form-outline mb-4">
                                                <input type="text" className="form-control form-control-lg" defaultValue={user.gender}  required minLength={3} maxLength={16} onBlur={(e) => { setGender(e.target.value) }} />
                                            ...
                                            <div className="form-outline mb-4">
                                                <input type="number" className="form-control form-control-lg" defaultValue={user.contact}  required minLength={3} maxLength={16} onBlur={(e) => { setContact(e.target.value) }} />
                                            ...
                                            <div className="form-outline mb-4">
                                                <input type="password" className="form-control form-control-lg" defaultValue={user.password}  required minLength={3} maxLength={16} onBlur={(e) => { setPassword(e.target.value) }} />
                                                <label className="form-label">Password</label>
                                            </div>


                                            <div className="pt-1 mb-4">
                                                <button className="btn btn-dark btn-lg btn-block" type="button" onClick={updateData}>Update Profile</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
