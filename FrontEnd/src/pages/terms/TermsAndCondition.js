...
export default function TermsAndCondition() {
  return (
    <div>
      ...
      Welcome to www.sharesteer.com This site is provided as a service to our visitors and may be used for informational purposes only. Because the Terms and Conditions contain legal obligations, please read them carefully.
